package com.kcet.canteen.utils;
...
public class AdvancedWebView extends WebView {
    ...
    public void setListener(final Activity activity, final AdvancedWebView.Listener listener) {
        setListener(activity, listener, REQUEST_CODE_FILE_PICKER);
    }

    public void setListener(final Activity activity, final AdvancedWebView.Listener listener, final int requestCodeFilePicker) {
        if (activity != null) {
    ...
    public void setListener(final Fragment fragment, final AdvancedWebView.Listener listener) {
        setListener(fragment, listener, REQUEST_CODE_FILE_PICKER);
    }

    public void setListener(final Fragment fragment, final AdvancedWebView.Listener listener, final int requestCodeFilePicker) {
        if (fragment != null) {
    ...
    protected void setListener(final AdvancedWebView.Listener listener, final int requestCodeFilePicker) {
        mListener = listener;
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(final WebView view, final String url) {
                ...
                if (!isPermittedUrl(url)) {
                    ...
                    Log.d("zzzzzz", "shouldOverrideUrlLoading: extern");
                ...
                if (scheme != null) {
                    ...
                    else if (scheme.equals("market") || scheme.equals("lazada")) {
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, im.delight.android.webview.AdvancedWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
